...
contract('SupplyChain', function(accounts) {
    ...
    const gasPrice = web3.toWei(0.5, "ether")
    var itemState = 0
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        var addDistributorEvent = supplyChain.DistributorAdded()
        await addDistributorEvent.watch((err, res) => {
            addDistributorEventEmitted = true
        })

        // Since the productPrice is 1 ether, thus sending 2 ether to compensate for the gas + refund
        var paidAmount =  web3.toWei("2", "ether")
        
        // Add distributorID to distributor Role
        ...
        assert.equal(addDistributorEventEmitted, true, 'Invalid event emitted')
        assert.equal(eventEmitted, true, 'Invalid event emitted')
    })    
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async() => {
        ...
        var addRetailerEvent = supplyChain.RetailerAdded()
        await addRetailerEvent.watch((err, res) => {
            addRetailerEventEmitted = true
        })

        // Add retailerID to retailer Role
    ...
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async() => {
        ...
        await addConsumerEvent.watch((err, res) => {
            addConsumerEventEmitted = true
        })

        // Add consumerID to retailer Role
